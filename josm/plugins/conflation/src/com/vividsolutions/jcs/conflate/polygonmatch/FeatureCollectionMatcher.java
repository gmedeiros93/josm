...
public class FeatureCollectionMatcher {
   ...
   */
  public Map<Feature, Matches> match(FeatureCollection targetFC, FeatureCollection candidateFC) {
    Map<Feature, Matches> map = new TreeMap<>();
    for (Feature subjectFeature : targetFC) {
